...
<div id="desc_pd" class="container tab-pane active" style='width:470px; margin: auto; padding-left:10px; padding-right: 20px'>
<br>
...
<div id="code_pd" class="container tab-pane fade"  style='width:470px; padding-left:10px; padding-right: 20px'>
<br>
```{r, eval=F, echo=T}
## Import libraries
library(FactoMineR)
